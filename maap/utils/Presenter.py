class Presenter:
    ...
    def __init__(self, capabilities, display_config):
        ...
        self.bbox = gen_bounding_box(wmts_contents['Layer']['ows:WGS84BoundingBox'])
    ...
    def display_config(self, display_config):
      return display_config or display_config_defaults[self.layer_title]      
